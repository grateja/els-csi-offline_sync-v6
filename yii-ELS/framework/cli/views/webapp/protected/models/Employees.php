<?php
    ...
    class Employees extends CActiveRecord {
        ...
        public function rules() {
            ...
            return array(
                array('created_at, employee_no, firstname, middlename, lastname, birthdate, department_id, location_id', 'required'),
                array('civil_status_id, region_id, province_id, municipality_id, barangay_id, office_id, citizenship_id, branch_id, contact_person_id, occupation_id, department_id, manager_id, is_agent, is_active, is_deleted, location_id', 'numerical', 'integerOnly' => true),
                ...
                array('id, created_at, updated_at, employee_no, firstname, middlename, lastname, mobile, phone, email, birthdate, civil_status_id, address1, address2, region_id, province_id, municipality_id, barangay_id, office_id, citizenship_id, branch_id, contact_person_id, occupation_id, department_id, manager_id, location_id, date_endo, is_agent, is_active, is_deleted', 'safe', 'on' => 'search'),
            );
        }
...
//        $crit->order = 'lastname asc';
        ...
        public static function model_getAllData_byDeletedClientID($isDeleted, $clientID) {
            $crit = new CDbCriteria();
            $crit->condition = 'is_deleted = :isDeleted AND client_id = :clientID';
            $crit->params = array(':isDeleted' => Utilities::NO, ':clientID' => $clientID);
//        $crit->order = 'lastname asc';
            return self::model()->findAll($crit);
        }
