...
//        }
    ...
    public static function get_AccountTypeID()
    {
        return Yii::app()->user->account_type_id;
    }
    ...
    const CONFIG_APPNAME1 = 1;
    const CONFIG_APPNAME2 = 2;
    const CONFIG_CHART_ACCOUNT_ID_AR = 3; // AMOUNT RECEIVABLE
    const CONFIG_CODE_LENGTH = 4;
    const CONFIG_CHART_OF_ACCOUNT_AP = 5;
    const CONFIG_CHART_OF_ACCOUNT_VAT = 6;
    const CONFIG_VAT_PERCENTAGE = 7;
    const CONFIG_CHART_OF_ACCOUNT_SALES = 8;
    const CONFIG_DEFAULT_LAWYER = 9;
    const CONFIG_SOA_NOTED_AND_APPROVED_BY = 10;
    const CONFIG_SOA_PREPARED_BY = 11;
    const CONFIG_CUSTOMER_NO_LENGTH = 12;
    const CONFIG_COMPANY_NAME = 13;
    const CONFIG_COSCENTER_GROUP_CODE = 14;
    const CONFIG_CHART_OF_ACCOUNT_SALES_DISCOUNT = 15;
    const CONFIG_CHART_OF_VAT_SETTINGS = 16;
    const CONFIG_CHART_OF_SERVICE_REVENUE = 17;
    const CONFIG_DUE_DATE_MULTIPLIER = 18;
