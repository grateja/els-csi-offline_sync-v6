...
try {
    ...
    $mPdf->SetXY(20, $y += 5);
    $mPdf->WriteCell(170, 6, 'Purchase Requisition', 0, 0, 'C');
...
//    $mPdf->WriteCell(170,6,'','B',0,'C'); //print line
    ...
    $y += 15;
    $mPdf->SetXY($x, $y);
    $mPdf->WriteCell(30, 6, 'Suggested Supplier:');
    $mPdf->WriteCell(100, 6, '', 'B');
    $mPdf->WriteCell(20, 6, '');
    $mPdf->WriteCell(10, 6, 'PR#:');
    $mPdf->WriteCell(20, 6, $modelHeader->ref_no, 'B'); //,0,'L');
//    
    $mPdf->SetXY($x, $y += 6);
    $mPdf->WriteCell(150, 6, '');
...
//    
    ...
    $mPdf->WriteCell(10, 6, '');
    $mPdf->WriteCell(45, 6, Settings::setCapitalAll(Employees::sql_getFullName($modelHeader->notedby_emp_id)), 'B');
    $mPdf->WriteCell(10, 6, '');
