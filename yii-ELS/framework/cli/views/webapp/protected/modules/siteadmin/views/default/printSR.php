...
//    $mPdf->WriteCell(170,6,'','B',0,'C'); //print line
    ...
    $y += 6;
    $mPdf->SetXY($x, $y += 6);
    $mPdf->WriteCell(35, 6, 'Prepared by:');
    $mPdf->WriteCell(10, 6, '');
    $mPdf->WriteCell(35, 6, 'Reviewed by:');
    $mPdf->WriteCell(10, 6, '');
    $mPdf->WriteCell(35, 6, 'Approved by:');

    $mPdf->SetXY($x, $y += 6);
    $mPdf->WriteCell(35, 6, Settings::setCapitalAll(Employees::sql_getFullName($modelHeader->prepared_emp_id)), 'B');
    $mPdf->WriteCell(10, 6, '');
    $mPdf->WriteCell(35, 6, Settings::setCapitalAll(Employees::sql_getFullName($modelHeader->reviewed_emp_id)), 'B');
    $mPdf->WriteCell(10, 6, '');
    $mPdf->WriteCell(35, 6, Settings::setCapitalAll(Employees::sql_getFullName($modelHeader->approved_emp_id)), 'B');
