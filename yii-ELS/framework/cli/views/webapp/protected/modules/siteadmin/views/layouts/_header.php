...
<header id="header">
    <div id="logo-group"  >
       <a href ="?r=siteadmin/default/index"><img src ="<?php print Settings::get_baseUrl(); ?>/images/company_logo.png" alt="logo"/><sup><?php print Settings::model_getValue_byID(Settings::CONFIG_APPNAME1)->value?></sup></a>
    </div>
