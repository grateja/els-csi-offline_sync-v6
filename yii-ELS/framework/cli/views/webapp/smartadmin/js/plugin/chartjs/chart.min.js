...
module.exports = function() {
	...
	Chart.defaults = {
		global: {
			...
			defaultFontFamily: "'Droid Sans', Helvetica, Arial, sans-serif",
			defaultFontSize: 12,
...
module.exports = function(Chart) {
	...
	function createTooltipItem(element) {
		...
		var yScale = element._yScale || element._scale; // handle radar || polarArea cha oprts
...
window.chartColors = {
	red: 'rgb(238, 95, 91)',
	orange: 'rgb(251, 180, 80)',
	yellow: 'rgb(255, 205, 86)',
	green: 'rgb(20, 155, 223)',
	blue: 'rgb(54, 162, 235)',
	purple: 'rgb(153, 102, 255)',
	grey: 'rgb(201, 203, 207)',
	green: 'rgb(152, 188, 100)',
...
(function(global) {
	...
	if (document.location.hostname === 'www.chartjs.org') {
		...
		(i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),/* global Chart */
