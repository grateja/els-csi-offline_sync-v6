    ...
    class UsersController extends SiteAdminController {
        ...
        public function actionCreate() {
            ...
            if (isset($_POST['Users'])) {
                ...
                //$modelClient  = Utilities::model_getByID(Clients::model(), $model->client_id);
              //  $model->email = $modelClient->email;
                $model->is_employee = Utilities::NO;
                $model->role = Roles::ROLE_ADMINISTRATOR;

                if ($model->validate()) {
                    $model->save();
                   // Clients::sql_updateIsAccountCreated($model->client_id, Utilities::YES);
