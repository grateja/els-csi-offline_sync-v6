...
class SuppliersController extends SiteAdminController {
    /**
    ...
    public function actionCreate()
    {
        ...
        if (isset($_POST['Suppliers'])) {
            ...
            if ($model->validate()) {
                $model->save();
                Utilities::set_Flash(Utilities::FLASH_SUCCESS, 'New Suppliers Successfully Created.');
    ...
    public function actionUpdate()
    {
        ...
        if (isset($_POST['Suppliers'])) {
            ...
            if ($model->validate()) {
                $model->save();
                Utilities::set_Flash(Utilities::FLASH_SUCCESS, 'Suppliers Successfully Updated');
                $this->redirect(array('view', 'id' => $model->id));
            } else {
                Utilities::set_Flash(Utilities::FLASH_ERROR, Utilities::get_ModelErrors($model->errors));
            }
    ...
    public function actionAdmin()
    {
        ...
        Utilities::setMenuActive_Siteadmin(Settings::get_ControllerID(), 'Suppliers::tbl()', Settings::get_ActionID());
    ...
    public function loadModel()
    {
        if ($this->_model === null) {
            if (isset($_GET['id']))
                $this->_model = Suppliers::model()->findbyPk($_GET['id']);
            if ($this->_model === null)
    ...
    {
        $this->redirect($this->createUrl('suppliers/create'));
    }
