...
<div class="box-body">
    ...
    <div class="form-group">
        ...
        <?php print CHtml::activeDropDownList($model, 'service_type_id',CHtml::listData(ServiceTypes::model_getAllData_byDeleted(Utilities::NO),'id','name'), array('class' => 'form-control', 'prompt' => '-- Select --')); ?>
    </div>
    <div class="form-group">
