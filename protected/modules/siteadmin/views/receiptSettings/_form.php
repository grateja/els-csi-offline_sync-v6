    ...
    <div class="form-group" style="text-align: center;">
        ...
        <div class="image-upload">
            <div class ="square-img">
                <?php
                print (!empty($_SESSION[ReceiptSettings::tbl()]['filename'])) ? CHtml::image(Settings::get_baseUrl() . "/" . $_SESSION[ReceiptSettings::tbl()]['path'] . "/" . $_SESSION[ReceiptSettings::tbl()]['filename'], '', array('id' => 'image-upload')) : CHtml::image(Settings::get_baseUrl() . "/images/noimage.png", '', array('id' => 'image-upload'));
                ?>
