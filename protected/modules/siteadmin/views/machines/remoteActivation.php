        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="md-form mb-5">
                    <?php echo CHtml::activeDropDownList($model, 'id', CHtml::listData(Customers::model_getAllData_byDeleted(Utilities::NO), 'id', 'lnameFname'), array('id' => "defaultForm-customer", 'class' => "select form-control validate", 'prompt' => '--select--')); ?>
...
<script type="text/javascript">
        window.onload = function () {
            ...
            for (i = 0; i < machineCount; i++) {
                ...
                $.ajax({
                    type: 'GET',
                    url: '?r=user/machines/getTotalMinutes',
...
//            }, 5000);
        ...
        function activate() {
            ...
            $.ajax({
                type: 'GET',
                url: '?r=user/machines/remoteActivationSubmit',
