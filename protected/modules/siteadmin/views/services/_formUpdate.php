    ...
    <div class="form-group" style="text-align: center;">
        ...
        <div class="image-upload">
            <div class ="square-img">
                <?php
                print (!empty($_SESSION[Services::tbl()]['filename'])) ? CHtml::image(Settings::get_baseUrl() . "/" . $_SESSION[Services::tbl()]['path'] . "/" . $_SESSION[Services::tbl()]['filename'], '', array('id' => 'image-upload')) : CHtml::image(Settings::get_baseUrl() . "/" . $model->file_path . "/" . $model->file_pics, '', array('id' => 'image-upload'));
                ?>
