...
<div class="box-body">
    ...
    <div class="form-group">    
        <?php
            if ($_SESSION[Expenses::tbl()]['expenses_type_id'] == '') {
        ...
        <?php print CHtml::activeDropDownList($model, 'expenses_type_id', CHtml::listData(ExpensesTypes::model_getAllData_byExpenseTypeID(Utilities::NO, 4), 'id', 'name'), array('value' => ExpensesTypes::EXPENSES_TYPE_SALARIES, 'class' => 'form-control', 'prompt' => 'Choose One', 'disabled' => 'disabled')); ?>
    </div>
