...
<div class="box-body">
    ...
    <div class="form-group">
        ...
        <?php print CHtml::activeDropDownList($model, 'supplier_id', CHtml::listData(Suppliers::model_getAllData_byDeleted(Utilities::NO), 'id', 'fullName'), array('class' => 'form-control', 'prompt' => '-- Select --')); ?>
    </div> 

    <div class="form-group">
        <?php print CHtml::activeLabelEx($model, 'Received By'); ?>
        <?php print CHtml::activeDropDownList($model, 'received_by_empid', CHtml::listData(Employees::model_getAllData_byDeleted(Utilities::NO), 'id', 'lnameFname'), array('class' => 'form-control', 'prompt' => '-- Select --')); ?>
    </div> 
    <div class="form-group">
