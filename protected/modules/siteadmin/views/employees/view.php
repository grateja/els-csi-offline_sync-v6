<div class="col-md-6">
    <div class="box box-primary">
        <div class="box-header with-border">
            ...
            <?php echo CHtml::link('<i class="fa fa-edit"></i>', $this->createUrl('employees/update', array('id' => $model->id)), array('class' => 'btn btn-xs btn-success pull-right', 'data-toggle' => 'tooltip', 'title' => 'Create')); ?>
