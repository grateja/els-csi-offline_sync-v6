<script type="text/javascript">
        ...
        function saveInventoryTransaction() {
            ...
            $.ajax({
                type: 'Get',
                url: '?r=user/posTransactions/saveInventoryTransaction',
        ...
        function searchTransactions() {
            ...
            $.ajax({
                type: 'Get',
                url: '?r=user/posTransactions/searchTransactions',
                data: 'custID=' + custID,
                async: false,
                success: function (data) {
                    var result = JSON.parse(data);
        ...
        function appendTransaction(transactionID) {
            ...
            $.ajax({
                type: 'Get',
                url: '?r=user/posTransactions/appendTransaction',
...
//
        ...
        function deleteInventory(val, transationID, isSaved) {
            ...
            $.ajax({
                type: 'Get',
                url: '?r=user/posTransactions/deleteInventory',
...
//
        ...
        function  retrieveCustomerPoints(custID) {
            $.ajax({
                type: 'Get',
                url: '?r=user/customers/retrieveCustomerPoints',
                data: 'custID=' + custID,
                async: false,
                success: function (data) {
                    var result = JSON.parse(data);
        ...
        function getDiscountType(val, id) {
            ...
            $.ajax({
                type: 'Get',
                url: '?r=user/posTransactions/getDiscountType',
                data: 'id=' + val,
                async: false,
                success: function (data) {
                    var result = JSON.parse(data);
        ...
        function saveTransactions() {
            ...
            $.ajax({
                type: 'Get',
                url: '?r=user/posTransactions/saveTransactions',
                data: 'custID=' + custID,
                async: false,
                success: function (data) {
                    console.log(data);
        ...
        function showPaymentModal() {
            ...
            var amountChange = 0;//numberWithCommas(parseFloat(totalPayable) - parseFloat($('#amountPaid').val()), 2);
        ...
        function submitPayment() {
            ...
            $.ajax({
                type: 'Get',
                url: '?r=user/posTransactions/submitPayment',
        ...
        function printReceipt() {
            ...
            $.ajax({
                type: 'Get',
                url: '?r=user/posTransactions/printReceipt',
        ...
        function showHidePaymentButton(custID) {
            $.ajax({
                type: 'Get',
                url: '?r=user/posTransactions/getUnsavedTransactions',
                data: 'custID=' + custID,
                async: false,
                success: function (data) {
                    if (data == 0) {
        ...
        function ajaxCreate()
        {
            ...
            $.ajax({
                type: 'POST',
                url: '?index.php&r=user/customers/ajaxCreate',
                data: data,
                success: function (data) {
        ...
        function getAmountInPeso(val) {
            ...
            if ($.isNumeric(parseFloat(val))) {
                $.ajax({
                    type: 'GET',
                    url: '?r=user/posTransactions/getPesoValue',
                    async: false,
                    success: function (data) {
                        ...
                        if (val <= totalPoints) {
                            if (val) {
                                ...
                                $('#amountInPeso').val(amountInPeso.toFixed(2));
