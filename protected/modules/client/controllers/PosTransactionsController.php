<?php
    ...
    class PosTransactionsController extends ClientController {
        /**
        ...
        public function actionAdminTransactionLists() {
            ...
            $rawData = PosTransactions::model()->findAll(' is_deleted = :isDeleted AND date(trans_date) between :startDate AND :endDate AND client_id = :branchID    order by  cust_id, updated_at DESC', array(
        ...
        public function actionAdminUnpaidTransactions() {
            ...
            $rawData = PosTransactions::model()->findAll(' client_id = :clientID  AND is_deleted = :isDeleted  AND is_fully_paid =:isFullyPaid order by cust_id', array(
                'isDeleted' => Utilities::NO,
