...
<div class="box-body">
    ...
    <div class="form-group">
        ...
        <?php print CHtml::activeDropDownList($model, 'emp_id', CHtml::listData(Employees::model_getAllData_byIsClientID(Utilities::NO, Settings::get_ClientID()), 'id', 'fullName'), array('class' => 'form-control', 'prompt' => 'Choose One')); ?>
    </div>
    <div class="form-group">    
   
        <?php print CHtml::activeLabelEx($model, 'expenses_type_id'); ?>
        <?php print CHtml::activeDropDownList($model, 'expenses_type_id', CHtml::listData(ExpensesTypes::model_getAllData_byExpenseTypeID(ExpensesTypes::EXPENSES_TYPE_SALARIES, Utilities::NO), 'id', 'name'), array('value'=> ExpensesTypes::EXPENSES_TYPE_SALARIES, 'class' => 'form-control salaryExpensesTypeID', 'prompt' => 'Choose One', 'disabled' => 'disabled')); ?>
    </div>
