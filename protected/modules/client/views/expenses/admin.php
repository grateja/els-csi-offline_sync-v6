...
//                    ),
                        array(
                            'name' => 'title',
                            'value' => '$data->title',
                            'filter' => $static + CHtml::listData(ExpensesTypes::model_getAllData_byDeleted(Utilities::NO), 'id', 'name'),
                            'headerHtmlOptions' => array(
                                'style' => 'width: 10%;'
                            ),
                        ),
                        ...
                        array(
                            ...
                            'filter' => $static + CHtml::listData(Employees::model_getAllData_byDeletedClientID(Utilities::NO, Settings::get_ClientID()), 'id', 'fullName'),
                            'headerHtmlOptions' => array(
                                'style' => 'width: 10%;'
                            ),
                        ),
