<script type="text/javascript">
        ...
        function saveInventoryTransaction() {
            ...
            $.ajax({
                type: 'Get',
                url: '?r=client/posTransactions/saveInventoryTransaction',
        ...
        function searchTransactions() {
            ...
            $.ajax({
                type: 'Get',
                url: '?r=client/posTransactions/searchTransactions',
                data: 'custID=' + custID,
                async: false,
                success: function (data) {
                    var result = JSON.parse(data);
...
//
        function appendTransaction(transactionID) {
            ...
            $.ajax({
                type: 'Get',
                url: '?r=client/posTransactions/appendTransaction',
...
//                        $('#totalDiscount').text(totaldiscount.toFixed(2));
        ...
        function deleteInventory(val, transationID, isSaved) {
            ...
            $.ajax({
                type: 'Get',
                url: '?r=client/posTransactions/deleteInventory',
...
//
        ...
        function getDiscountType(val, id) {
            ...
            $.ajax({
                type: 'Get',
                url: '?r=client/posTransactions/getDiscountType',
                data: 'id=' + val,
                async: false,
                success: function (data) {
                    var result = JSON.parse(data);
        ...
        function saveTransactions() {
            ...
            $.ajax({
                type: 'Get',
                url: '?r=client/posTransactions/saveTransactions',
                data: 'custID=' + custID,
                async: false,
                success: function (data) {
                    showHidePaymentButton(custID);
        ...
        function showPaymentModal() {
            ...
            var amountChange = numberWithCommas(parseFloat(totalPayable) - parseFloat($('#amountPaid').val()), 2);

            $('#amountChange').html(amountChange.toFixed(2));
        ...
        function  retrieveCustomerPoints(custID) {
            $.ajax({
                type: 'Get',
                url: '?r=client/customers/retrieveCustomerPoints',
                data: 'custID=' + custID,
                async: false,
                success: function (data) {
        ...
        function calculateTotalAmountNet(value, amountPaid) {
            ...
            var totalAmountPaid = parseFloat(value.replace(/,/g, '')) + parseFloat(amountPaid);
        ...
        function submitPayment() {
            ...
            $.ajax({
                type: 'Get',
                url: '?r=client/posTransactions/submitPayment',
        ...
        function printReceipt() {
            ...
            $.ajax({
                type: 'Get',
                url: '?r=client/posTransactions/printReceipt',
        ...
        function showHidePaymentButton(custID) {
            $.ajax({
                type: 'Get',
                url: '?r=client/posTransactions/getUnsavedTransactions',
                data: 'custID=' + custID,
                async: false,
                success: function (data) {
                    if (data == 0) {
        ...
        function ajaxCreate()
        {
            ...
            $.ajax({
                type: 'POST',
                url: '?index.php&r=client/customers/ajaxCreate',
                data: data,
                success: function (data) {
