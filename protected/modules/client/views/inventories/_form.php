...
<div class="box-body">
    <div class="form-group" style="text-align: center;">
     ...
     <div class="form-group">
        ...
        <?php print CHtml::activeDropDownList($model, 'branch_id', CHtml::listData(Branches::model_getAllData_byClientId(Settings::get_ClientID()), 'id', 'name'), array('class' => 'form-control', 'prompt' => '-- Select --', 'onChange' => 'showHideTokenField(this.value)')); ?>
    </div>
    <div class="form-group">
    ...
    <?php if ($categoryID == InventoryCategories::INVENTORY_TYPE_SERVICES): ?>
            <div class="form-group">
