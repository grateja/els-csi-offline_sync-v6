...
<div class="box-body">
    ...
    <div class="form-group">
        ...
        <?php print CHtml::activeDropDownList($model, 'emp_id', CHtml::listData(Employees::model_getAllData_byIsClientID(Utilities::NO, Settings::get_ClientID()), 'id', 'fullName'), array('class' => 'form-control', 'promp' => 'Choose One')); ?>
    </div>
    <div class="form-group">
        <?php print CHtml::activeLabelEx($model, 'branch_id'); ?>
        <?php print CHtml::activeDropDownList($model, 'branch_id', CHtml::listData(Branches::model_getAllData_byClientId(Settings::get_ClientID()), 'id', 'name'), array('class' => 'form-control', 'promp' => 'Choose One')); ?>
    </div>
    <div class="form-group">
