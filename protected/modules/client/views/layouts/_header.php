...
<!--                <li class="dropdown messages-menu">
                    ...
                    <?php if (Utilities::get_isOnline() == Utilities::YES): ?>
                            <a href="#" class="dropdown-toggle btn btn-success" onclick='js: syncToLiveServer()'>
                                <i class="fa fa-upload"> Sync</i>
                            </a>
                        <?php else: ?>
                            <a href="#" class="dropdown-toggle btn " disabled='disabled'>
                                <i class="fa fa-upload"> Sync</i>
                            </a>
                    <?php endif; ?>
...
<!--                <li class="dropdown messages-menu">
                    <a href="#" class="dropdown-toggle"class="btn btn-default" data-toggle="modal" data-target="#topupModal">
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <?php echo CHtml::link('<i class="fa fa-user">Profile</i>', $this->createUrl('clients/view', array('id' => $model->id)), array('class' => 'btn btn-default btn-flat pull-right', 'data-toggle' => 'tooltip', 'title' => 'Create')); ?>
