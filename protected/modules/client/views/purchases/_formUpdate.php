...
<div class="box-body">
    ...
    <div class="form-group">
        ...
        <?php echo CHtml::activeDropDownList($model, 'inv_id', CHtml::listData(Inventories::model_getAllProducts_byCategoryIDClientID(InventoryCategories::INVENTORY_TYPE_SERVICES, Utilities::NO, Settings::get_ClientID()), 'id', 'name'), array('class' => 'form-control', 'prompt' => '--select--')); ?>
    </div>
