<?php
    ...
    class PurchasesController extends BackOfficeController {
        /**
        ...
        public function actionAdminReports() {
            ...
            $rawData = Purchases::model()->findAll(' is_deleted = :isDeleted  AND branch_id = :branchID AND date(updated_at) between :startDate AND :endDate  order by   updated_at DESC', array(
                'endDate' => $endDate,
                'startDate' => $startDate,
