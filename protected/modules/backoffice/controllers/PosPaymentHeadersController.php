<?php
    ...
    class PosPaymentHeadersController extends BackOfficeController {
        /**
        ...
        public function actionAdminReceipts() {
            ...
            $rawData = PosPaymentHeaders::model()->findAll(' is_deleted = :isDeleted AND branch_id = :branchID   order by or_no DESC', array(
                'isDeleted' => Utilities::NO,
