...
class SalariesController extends BackOfficeController {
    /**
    ...
    public function actionCreate()
    {
        ...
        if (isset($_POST['Salaries'])) {
            ...
            if ($model->validate()) {
                $model->save();
                Utilities::set_Flash(Utilities::FLASH_SUCCESS, 'New Salaries Successfully Created.');
    ...
    public function actionUpdate()
    {
        ...
        if (isset($_POST['Salaries'])) {
            ...
            if ($model->validate()) {
                $model->save();
                Utilities::set_Flash(Utilities::FLASH_SUCCESS, 'Salaries Successfully Updated');
                $this->redirect(array('view', 'id' => $model->id));
            } else {
                Utilities::set_Flash(Utilities::FLASH_ERROR, Utilities::get_ModelErrors($model->errors));
            }
    ...
    {
        $dataProvider = new CActiveDataProvider('Salaries');
    ...
    public function actionAdmin()
    {
        ...
        Utilities::setMenuActive_Siteadmin(Settings::get_ControllerID(), 'Salaries::tbl()', Settings::get_ActionID());
        $model = new Salaries('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Salaries']))
            $model->attributes = $_GET['Salaries'];
    ...
    public function loadModel()
    {
        if ($this->_model === null) {
            if (isset($_GET['id']))
                $this->_model = Salaries::model()->findbyPk($_GET['id']);
            if ($this->_model === null)
    ...
    {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'salaries-form') {
