<?php
    ...
    class MachinesController extends BackOfficeController {
        /**
        ...
        public function accessRules() {
            return array(
                array('allow', // allow all users to perform 'index' and 'view' actions
                    ...
                    'actions' => array('create', 'admin', 'create', 'update', 'createTransaction', 'selectCustomer', 'removeCustomer', 'remoteActivation', 'remoteActivationSubmit', 'getTotalMinutes','delete'),
                    'users' => array('@'),
                ),
