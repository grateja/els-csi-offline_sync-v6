<?php
    ...
    class InventoriesController extends BackOfficeController {
        /**
...
//            Utilities::debug( Settings::get_BranchID(), $caption);exit(); 
            $model = new Inventories('searchBranch');
        ...
        public function actionAdminReports() {
            ...
            $rawData = Inventories::model()->findAll(' is_deleted = :isDeleted AND branch_id = :branchID  AND date(updated_at) between :startDate AND :endDate  order by   updated_at DESC', array(
                'endDate' => $endDate,
                'startDate' => $startDate,
