...
<div class="box-body">
    ...
    <div class="form-group">
        ...
        <?php echo CHtml::activeDropDownList($model, 'is_deleted', Utilities::get_ActiveSelect(), array('class' => 'form-control', 'prompt' => '-- select --', 'id' => 'divStatus', 'onChange' => 'checkStatus(this.value)')); ?>
    </div>
