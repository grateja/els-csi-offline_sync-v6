...
<!--<?php print Settings::get_employeeID();?>-->
<div class ="col-lg-8">
                                ...
                                <li>
                                    <a>
                                        <div class="small-box" onclick="showQuantityModal(<?= $model->id; ?>)">
                                            <div class="col-sm-2">
                                                ​<picture >
                                                    <img src="<?= Settings::get_baseUrl() . '/' . $model->file_path . $model->file_pics; ?>" class="img-fluid img-thumbnail" alt="<?= $model->desc ?>" title="<?= $model->name ?>">
                                                    <figcaption style="text-align: center;">
                                                        <strong><?= $model->name ?></strong><br>
                                                        ₱ <?= Settings::setNumberFormat($model->price, 2) ?><br>
                                                        <!--<strong>Stock: </strong> (<?= $model->qty_stock ?>)<br>-->
                                                    </figcaption>
                                                </picture>
                                            </div>
                                        </div>
            ...
            <form action="#" method="post">
                <div class="form-group">
                    <div class="input-group input-group-sm">     
                        <?php echo CHtml::activeDropDownList($posTransactions, 'cust_id', CHtml::listData(Customers::model_getAllData_byDeletedCLientID(Utilities::NO, Settings::get_ClientID()), 'id', 'lnameFname'), array('prompt' => '--Select Customer--', 'id' => 'customerName', 'class' => 'form-control select2 select2-hidden-accessible', 'style' => 'width: 100%;', 'onChange' => 'searchTransactions()')); ?>
                ...
                <table class="table table-striped table-bordered table-hover">
                    <tbody>
                        ...
                        <tr>
                            <td width="70%" style="text-align:right;"><span id="add_discount"> <b>Point(s) Earned</b></span></td>
                            <td class="text-right"  style="font-weight:bold;"><span id="pointID">0</span></td>
                        </tr>
