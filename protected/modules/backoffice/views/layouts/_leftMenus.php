...
<li class="treeview">
    <a href="#">
        <i class="fa fa-credit-card"></i> <span>RFID</span>
        <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
        </span>
    </a>
    <ul class="treeview-menu">
        <li><?php print CHtml::link('<i class="fa fa-circle-o"></i>Prices', $this->createUrl('servicePrices/admin')); ?></li>
        <li><?php print CHtml::link('<i class="fa fa-circle-o"></i>Transactions', $this->createUrl('customerCardTransactions/admin')); ?></li>
...
<li class="treeview">
    <a href="#">
        <i class="fa fa-gears"></i> <span>Branch</span>
        <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
        </span>
    </a>
    <ul class="treeview-menu">
        <li><?php print CHtml::link('<i class="fa fa-circle-o"></i>Profile', $this->createUrl('branches/view', array('id' => Settings::get_BranchID()))); ?></li>
        <li><?php print CHtml::link('<i class="fa fa-circle-o"></i>Discount', $this->createUrl('discounts/admin')); ?></li>
        <!--<li><?php // print CHtml::link('<i class="fa fa-circle-o"></i>Loyalty Tpye', $this->createUrl('loyaltyTypes/create')); ?></li>-->
