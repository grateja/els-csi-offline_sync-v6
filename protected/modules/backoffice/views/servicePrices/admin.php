                ...
                $this->widget('zii.widgets.grid.CGridView', array(
                    ...
                    'columns' => array(
                        ...
                        array(
                            ...
                            'filter' => $static + CHtml::listData(Inventories::model_getAllProducts_byCategoryIDClientID_isDeleted(InventoryCategories::INVENTORY_TYPE_SERVICES, Utilities::NO, Settings::get_ClientID()), 'id', 'name'),
                            'headerHtmlOptions' => array(
                                'style' => 'width: 10%;'
                            ),
                        ),
