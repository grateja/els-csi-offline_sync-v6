<div class="col-md-6">
    <div class="box box-primary">
        <div class="box-header with-border">
            ...
            <?php echo CHtml::link('<i class="fa fa-edit"></i>', $this->createUrl('branches/update' ,array('id' => Settings::get_BranchID())), array('class' => 'btn btn-xs btn-success pull-right', 'data-toggle' => 'tooltip', 'title' => 'Update')); ?>
