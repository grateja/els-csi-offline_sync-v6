...
<div class="box-body">
    ...
    <div style ='display: none' id="divCardUser">
        <div class="form-group">
            ...
            <?php echo CHtml::activeDropDownList($model, 'card_user_id', CHtml::listData(Employees::model_getAllData_byIsWithCard_andIsDeleted(Utilities::NO,Utilities::NO), 'id', 'lnameFname'), array('prompt' => '-- Select --', 'class' => 'form-control', 'style' => 'width: 100%','placeholder' => 'Rf ID', 'value' => $_SESSION[CustomerCards::tbl()]['card_user_id'])); ?>
        </div>
    </div>
</div>
