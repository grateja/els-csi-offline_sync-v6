    ...
    class SiteController extends FrontController {
        ...
        public function actionLogin() {
            ...
            if (isset($_POST['LoginForm'])) {
                ...
                if ($model->validate()) {
                    $role = Utilities::model_getByID($role, Settings::get_roleID());
                    $modules = Utilities::model_getByID($modules, $role->module_id);
                    $this->redirect($this->createUrl($modules->name . '/default/index'));
                } else {
        ...
        public function actionTest() {
            ...
            foreach ($tablesWithClientID as $tableWithClientID) {
                Utilities::sql_updateTableColumnTest($columnName, $tableWithClientID['table_name'], Utilities::NO);
            }
        }
