...
// will receive user inputs.
        return array(
            ...
            array('name, details', 'length', 'max' => 100),
            array('updated_at', 'safe'),
// The following rule is used by search().
// Please remove those attributes that should not be searched.
            array('id, created_at, updated_at, name, details, is_sync, is_deleted', 'safe', 'on' => 'search'),
        );
    }
...
// should not be searched.
        ...
        return new CActiveDataProvider('Subscriptions', array(
            'criteria' => $criteria,
        ));
    }
