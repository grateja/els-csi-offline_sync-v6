<?php
    ...
    class Roles extends CActiveRecord {
        ...
        public static function model_getAllData_byRoleIsDeleted($isDeleted, $role) {
            return self::model()->findAll('id in(4,5) AND is_deleted = :isDeleted', array(':isDeleted' => $isDeleted));
        }
