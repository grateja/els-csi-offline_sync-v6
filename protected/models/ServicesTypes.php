 ...
 *
 * The followings are the available columns in table 'services_types':
 * @property integer $id
 ...
 */
class ServicesTypes extends CActiveRecord {
...
// should not be searched.
        ...
        return new CActiveDataProvider('ServicesTypes', array(
            'criteria' => $criteria,
        ));
    }
     ...
     * @return ServicesTypes the static model class
     */
