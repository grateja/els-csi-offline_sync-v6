...
/**
 * This is the model class for table "civil_statuses".
 *
 * The followings are the available columns in table 'civil_statuses':
 * @property integer $id
 ...
 */
class CivilStatuses extends CActiveRecord {
    ...
    public function search()
    {
        ...
        return new CActiveDataProvider('CivilStatuses', array(
            'criteria' => $criteria,
            'pagination' => array(
     ...
     * @return CivilStatuses the static model class
     */
