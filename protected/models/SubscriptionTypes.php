...
/**
 * This is the model class for table "subscription_types".
 *
 * The followings are the available columns in table 'subscription_types':
 * @property integer $id
 ...
 */
class SubscriptionTypes extends CActiveRecord {
...
// should not be searched.
        ...
        return new CActiveDataProvider('SubscriptionTypes', array(
            'criteria' => $criteria,
        ));
    }
     ...
     * @return SubscriptionTypes the static model class
     */
