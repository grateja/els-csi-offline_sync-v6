 ...
 *
 * The followings are the available columns in table 'expenses_types':
 * @property integer $id
 ...
 */
class ExpensesTypes extends CActiveRecord {
    const EXPENSES_TYPE_UTILITIES = 1;
    const EXPENSES_TYPE_RENTALS = 2;
    const EXPENSES_TYPE_SALARIES = 3;
    const EXPENSES_TYPE_PURCHASES = 4;
    const EXPENSES_TYPE_OTHERS = 5;
    /**
    ...
    public function search()
    {
        ...
        return new CActiveDataProvider('ExpensesTypes', array(
            'criteria' => $criteria,
        ));
    }
     ...
     * @return ExpensesTypes the static model class
     */
    ...
    public static function model_getAllData_byExpenseTypeID($expensesID,$isDeleted)
    {
        return self::model()->findAll('id = :expensesID AND is_deleted = :isDeleted', array(':expensesID' => $expensesID,':isDeleted' => $isDeleted));
    }
