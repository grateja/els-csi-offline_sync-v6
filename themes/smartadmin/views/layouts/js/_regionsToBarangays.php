...
Yii::app()->clientScript->registerScript("findCityByProv", "
        ...
        function findProvince()
        {
            ...
            $.ajax({
                type    : 'GET',
                url     : '" . Yii::app()->createUrl("provinces/ajaxSearchProvinces") . "',
        ...
        function findCity()
        {
            ...
            $.ajax({
                type    : 'GET',
                url     : '" . Yii::app()->createUrl("municipalities/ajaxSearchMunicipalities") . "',
        ...
        function findBarangay()
        {
            ...
            $.ajax({
                type    : 'GET',
                url     : '" . Yii::app()->createUrl("barangays/ajaxSearchBarangays") . "',
