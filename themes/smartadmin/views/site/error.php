<div id="content" style="opacity: 1;"><style>
        .error-text-2 {
            text-align: center;
            font-size: 700%;
            font-weight: bold;
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="text-center error-box">
                        ...
                        <p class="font-md">
                            <b>Please click     <?php echo CHtml::link(' here ', $this->createUrl('site/login'), array('class' => 'text-primary', 'data-toggle' => 'tooltip', 'title' => 'Create')); ?>login to continue!.</b>
                        </p>
                        <br>
